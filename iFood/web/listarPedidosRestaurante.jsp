                                                        ...
                                                        <c:forEach items="${Pedido}" var="Pedido">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <form action ="FrontController?pacote=pedido&action=VoltarEstado&id=${Pedido.id}&restauranteId=${restaurante.id}" method="post">
                                                                        <input type="submit" value="Voltar Estado"/>
                                                                    </form>
