                ...
                <li class="nav-item active">
                    <a class="nav-link" href="index.html">
                        ...
                        <div id="content-wrapper" class="d-flex flex-column">
                            ...
                            <form  class="form-horizontal" action="FrontController?pacote=comida&action=UploadImagem&id=${comida.id}" method="post" enctype="multipart/form-data" name="formulario" id="formulario"
